...
1. Run `specdev next --json`. If no workflow is focused, run `specdev do "start a discussion"`.
2. Follow the graph instruction to run `specdev discussion "<description>"` and use the returned folder path.
